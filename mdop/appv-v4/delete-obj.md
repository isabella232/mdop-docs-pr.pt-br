...
Remove todos os seus registros de aplicativo.
...
<td align="left"><p>Se especificado, todos os aplicativos são removidos. Por padrão, somente os aplicativos aos quais o usuário atual tem acesso são removidos.</p></td>
</tr>
<tr class="even">
