...
Remove a associação de tipo de arquivo especificada.
...
<td align="left"><p>A extensão de nome de arquivo a ser removida.</p></td>
</tr>
<tr class="even">
<td align="left"><p>/GLOBAL</p></td>
<td align="left"><p>Se especificado, indica que a associação global para a extensão de nome de arquivo deve ser removida.</p></td>
</tr>
<tr class="odd">
