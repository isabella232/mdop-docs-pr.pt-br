...
Você pode criar a imagem de recuperação do Microsoft Diagnostic and Recovery Toolset (DaRT) 10 usando um script do PowerShell em vez de usar o assistente de imagem de recuperação do DaRT 10. Consulte o exemplo de script a seguir.
