...
ms.locfileid: "10799147"
---
# <span data-ttu-id="0ff11-103">Como usar um script do PowerShell para criar a imagem de recuperação</span><span class="sxs-lookup"><span data-stu-id="0ff11-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="0ff11-104">Para criar a imagem de recuperação do DaRT usando um script do PowerShell</span><span class="sxs-lookup"><span data-stu-id="0ff11-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="0ff11-105">Você pode criar a imagem de recuperação do Microsoft Diagnostic and Recovery Toolset (DaRT) 10 usando um script do PowerShell em vez de usar o assistente de imagem de recuperação do DaRT 10.</span><span class="sxs-lookup"><span data-stu-id="0ff11-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 10 recovery image by using a PowerShell script instead of using the DaRT 10 Recovery Image wizard.</span></span> <span data-ttu-id="0ff11-106">Consulte o exemplo de script a seguir.</span><span class="sxs-lookup"><span data-stu-id="0ff11-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="0ff11-107">Configur</span><span class="sxs-lookup"><span data-stu-id="0ff11-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="0ff11-108">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="0ff11-108">Related topics</span></span>


[<span data-ttu-id="0ff11-109">Administrar o DaRT 10 usando o PowerShell</span><span class="sxs-lookup"><span data-stu-id="0ff11-109">Administering DaRT 10 Using PowerShell</span></span>](administering-dart-10-using-powershell.md)
