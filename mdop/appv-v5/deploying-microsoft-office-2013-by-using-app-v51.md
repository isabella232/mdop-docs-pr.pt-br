...
Use as informações neste artigo para usar o Microsoft Application Virtualization (App-V) 5,1 ou versões posteriores para fornecer o Microsoft Office 2013 como um aplicativo virtualizado para computadores em sua organização. Para obter informações sobre como usar o App-V para fornecer o Office 2010, consulte [implantando o Microsoft Office 2010 usando o app-v](deploying-microsoft-office-2010-by-using-app-v51.md). Para implantar com êxito o Office 2013 com o App-V, você precisa estar familiarizado com o Office 2013 e o App-V.
...
<tbody>
<tr class="odd">
<td align="left"><p><a href="planning-for-using-app-v-with-office51.md#bkmk-office-vers-supp-appv" data-raw-source="[Planning for Using App-V with Office](planning-for-using-app-v-with-office51.md#bkmk-office-vers-supp-appv)">Planejando o uso do App-V com o Office</a></p></td>
<td align="left"><ul>
...
<tr class="even">
<td align="left"><p><a href="planning-for-using-app-v-with-office51.md#bkmk-plan-coexisting" data-raw-source="[Planning for Using App-V with Office](planning-for-using-app-v-with-office51.md#bkmk-plan-coexisting)">Planejando o uso do App-V com o Office</a></p></td>
...
Conclua as etapas a seguir para criar um pacote do Office 2013 para o App-V 5,1 ou posterior.

**Importante**  
No App-V 5,1 e posterior, você deve ter a ferramenta de implantação do Office para criar um pacote. Você não pode usar o sequenciador para criar pacotes.
...
<td align="left"><ul>
<li><p>versão de 64 bits do Windows 8 ou posterior</p></li>
...
Crie pacotes do Office 2013 App-V em computadores com Windows de 64 bits. Uma vez criado, o pacote do Office 2013 App-V será executado em computadores com o Windows 7, o Windows 8,1 e o Windows 10 com 32 bits e 64 bits.
...
-   Crie os pacotes do Office 2013 App-V em computadores com Windows de 64 bits. No entanto, o pacote será executado em computadores 64 com o Windows 7, Windows 8 e Windows 10 em 32 bits.
...
## <a href="" id="bkmk-pub-pkg-office"></a>Publicando o pacote do Office para o App-V 5,1
...
2.  Sequenciar seus plug-ins usando o sequenciador do App-V 5,1. Verifique se o Office 2013 está instalado no computador que está sendo usado para sequenciar o plug-in. É recomendável usar os aplicativos do Microsoft 365 para empresas (não virtuais) no computador de sequenciamento quando você sequenciar plug-ins do Office 2013.

3.  Crie um pacote do App-V 5,1 que inclua os plug-ins desejados.
