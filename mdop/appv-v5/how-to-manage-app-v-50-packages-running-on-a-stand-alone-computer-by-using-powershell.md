...
---
# Como gerenciar pacotes do App-V 5.0 em execução em um computador autônomo usando o PowerShell
...
Para usar o console de gerenciamento do App-V para definir essa configuração, consulte [como publicar um pacote usando o console de gerenciamento](how-to-publish-a-package-by-using-the-management-console-50.md).
