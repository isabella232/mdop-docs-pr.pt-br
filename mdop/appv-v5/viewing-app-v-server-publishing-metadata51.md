...
-   [Requisitos do App-V 5,1 para visualização de metadados de publicação](#bkmk-51-reqs-pub-meta)
...
## <a href="" id="bkmk-51-reqs-pub-meta"></a>Requisitos do App-V 5,1 para visualização de metadados de publicação


No App-V 5,1, você deve fornecer os seguintes valores no endereço quando consulta o servidor de publicação App-V para metadados:
...
<td align="left"><p>Se você omitir <strong> o </strong> parâmetro ClientVersion da consulta, os metadados excluirão os recursos que foram novos no App-V 5,0 SP3.</p></td>
</tr>
<tr class="even">
...
<div class="alert">
<strong>Observação</strong><br/><p><strong></strong> <strong> </strong> Só há suporte para ClientVersion e ClientOS no app-v 5,0 SP3 e no app-v 5,1.</p>
</div>
<div>

</div></td>
<td align="left"><p>Consulte as informações para o App-V 5,0 SP3 e o App-V 5,1.</p></td>
