...
1. Para abrir um console do PowerShell, clique em **Iniciar** e digite **PowerShell**. Clique com o botão direito do mouse em **Windows PowerShell** e selecione **Executar como Administrador**.
...
1. Execute o script que você salvou na etapa um deste procedimento passando as contas para converter como argumentos.
