...
Para alterar o local padrão do armazenamento de pacotes durante a instalação, consulte [How to Deploy the App-V Client](how-to-deploy-the-app-v-client-51gb18030.md).
