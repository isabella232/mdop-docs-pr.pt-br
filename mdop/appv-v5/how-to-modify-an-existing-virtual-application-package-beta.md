...
-   Verifique se você instalou o sequenciador do Microsoft Application Virtualization (App-V), que é necessário para modificar um pacote de aplicativo virtual. Para instalar o sequenciador do App-V, consulte [como instalar o sequenciador](how-to-install-the-sequencer-beta-gb18030.md).
