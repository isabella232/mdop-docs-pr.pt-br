...
---
# Como implantar o servidor do App-V 5.1


Use o procedimento a seguir para instalar o servidor do Microsoft Application Virtualization (App-V) 5,1. Para obter informações sobre a implantação do servidor do App-V 5,1, consulte [sobre o app-v 5,1](about-app-v-51.md#bkmk-migrate-to-51).

**Antes de começar:**

-   Verifique se você instalou o software de pré-requisito. Consulte [pré-requisitos do App-V 5,1](app-v-51-prerequisites.md).

-   Examine a seção de servidor das [considerações de segurança do App-V 5,1](app-v-51-security-considerations.md).
...
4. Na página **seleção de recursos** , selecione todos os componentes a seguir.
   ...
   <td align="left"><p>Oferece o App-V 5,1 Reporting Services.</p></td>
   </tr>
   <tr class="odd">
