...
O App-V 5,0 SP2 permite o uso do redirecionamento de pastas, um recurso que permite aos usuários e administradores redirecionar o caminho de uma pasta para um novo local.
...
<tr class="even">
<td align="left"><p>No App-V 5,0 SP3</p></td>
...
<p>Para fornecer redundância, o App-V 5,0 mantém as três cópias mais recentes dos dados compactados em% AppData%.</p></td>
</tr>
</tbody>
</table>
