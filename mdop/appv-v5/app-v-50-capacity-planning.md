...
<span data-ttu-id="d7eea-149">**Observação**  Tempo de resposta de ida e volta no cliente é o tempo levado pelo computador executando o cliente App-V 5,0 para receber uma notificação bem-sucedida do servidor de publicação.</span><span class="sxs-lookup"><span data-stu-id="d7eea-149">**Note** Round trip response time on the client is the time taken by the computer running the App-V 5.0 client to receive a successful notification from the publishing server.</span></span> <span data-ttu-id="d7eea-150">O tempo de resposta de ida e volta no servidor de publicação é o tempo usado pelo computador que executa o servidor de publicação para receber uma atualização de metadados de pacote bem-sucedida do servidor de gerenciamento.</span><span class="sxs-lookup"><span data-stu-id="d7eea-150">Round trip response time on the publishing server is the time taken by the computer running the publishing server to receive a successful package metadata update from the management server.</span></span>
...
1.  <span data-ttu-id="d7eea-161">Número de servidores de publicação que fazem solicitações simultâneas.</span><span class="sxs-lookup"><span data-stu-id="d7eea-161">Number of publishing servers making simultaneous requests.</span></span>
...
<tr class="even">
<td align="left"><p><span data-ttu-id="d7eea-173">O número de grupos de conexão configurados no servidor de gerenciamento.</span><span class="sxs-lookup"><span data-stu-id="d7eea-173">The number of connection groups configured on the management server.</span></span></p>
<p></p></td>
<td align="left"><p></p>
<ul>
...
<th align="left"><span data-ttu-id="d7eea-185">Servidor de publicação do tipo de conexão de rede/servidor de gerenciamento</span><span class="sxs-lookup"><span data-stu-id="d7eea-185">Network connection type publishing server / management server</span></span></th>
...
<li><p><span data-ttu-id="d7eea-233">400</span><span class="sxs-lookup"><span data-stu-id="d7eea-233">400</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<ul>
...
<th align="left"><span data-ttu-id="d7eea-295">Variação</span><span class="sxs-lookup"><span data-stu-id="d7eea-295">Variation</span></span></th>
...
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="d7eea-314">um</span><span class="sxs-lookup"><span data-stu-id="d7eea-314">1</span></span></p></li>
...
<li><p><span data-ttu-id="d7eea-340">O tempo de resposta de ida e volta do servidor de relatório é de 5,65 segundos para os clientes do 1000.</span><span class="sxs-lookup"><span data-stu-id="d7eea-340">Round trip response time from the reporting server is 5.65 seconds for 1000 clients.</span></span></p></li>
...
-   <span data-ttu-id="d7eea-363">O número de pacotes em cada atualização.</span><span class="sxs-lookup"><span data-stu-id="d7eea-363">The number of packages in each refresh.</span></span>
...
<tr class="odd">
<td align="left"><p><span data-ttu-id="d7eea-375">Rede entre o cliente App-V 5,0 e o Publishing Server.</span><span class="sxs-lookup"><span data-stu-id="d7eea-375">Network between the App-V 5.0 client and the publishing server.</span></span></p>
<p></p></td>
<td align="left"><p></p>
<ul>
...
<tbody>
<tr class="odd">
<td align="left"><p><span data-ttu-id="d7eea-387">App-V 5,0 o cliente envia uma solicitação &amp; de atualização de publicação recebe resposta, cada solicitação contendo pacotes 120</span><span class="sxs-lookup"><span data-stu-id="d7eea-387">App-V 5.0 client sends publishing refresh request &amp; receives response, each request containing 120 packages</span></span></p></td>
...
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="d7eea-409">100</span><span class="sxs-lookup"><span data-stu-id="d7eea-409">100</span></span></p></li>
...
<td align="left"><p><span data-ttu-id="d7eea-428">rede de link lento de 1,5 Mbps</span><span class="sxs-lookup"><span data-stu-id="d7eea-428">1.5 Mbps Slow link network</span></span></p></td>
<td align="left"><p></p>
<ul>
...
<td align="left"><p><span data-ttu-id="d7eea-466">Número de clientes.</span><span class="sxs-lookup"><span data-stu-id="d7eea-466">Number of clients.</span></span></p></td>
<td align="left"><p></p>
<ul>
...
<li><p></p></li>
<li><p><span data-ttu-id="d7eea-488">35</span><span class="sxs-lookup"><span data-stu-id="d7eea-488">35</span></span></p></li>
<li><p><span data-ttu-id="d7eea-489">68</span><span class="sxs-lookup"><span data-stu-id="d7eea-489">68</span></span></p></li>
<li><p><span data-ttu-id="d7eea-490">461</span><span class="sxs-lookup"><span data-stu-id="d7eea-490">461</span></span></p></li>
</ul></td>
</tr>
<tr class="even">
<td align="left"><p><span data-ttu-id="d7eea-491">Tamanho de cada pacote que está sendo transmitido.</span><span class="sxs-lookup"><span data-stu-id="d7eea-491">Size of each package being streamed.</span></span></p></td>
<td align="left"><p><span data-ttu-id="d7eea-492">Tamanho de cada pacote.</span><span class="sxs-lookup"><span data-stu-id="d7eea-492">Size of each package.</span></span></p></td>
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="d7eea-493">100</span><span class="sxs-lookup"><span data-stu-id="d7eea-493">100</span></span></p></li>
<li><p><span data-ttu-id="d7eea-494">200</span><span class="sxs-lookup"><span data-stu-id="d7eea-494">200</span></span></p></li>
<li><p></p></li>
<li><p><span data-ttu-id="d7eea-495">100</span><span class="sxs-lookup"><span data-stu-id="d7eea-495">100</span></span></p></li>
<li><p><span data-ttu-id="d7eea-496">200</span><span class="sxs-lookup"><span data-stu-id="d7eea-496">200</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="d7eea-497">21 MB</span><span class="sxs-lookup"><span data-stu-id="d7eea-497">21 MB</span></span></p></li>
<li><p><span data-ttu-id="d7eea-498">21 MB</span><span class="sxs-lookup"><span data-stu-id="d7eea-498">21 MB</span></span></p></li>
<li><p></p></li>
<li><p><span data-ttu-id="d7eea-499">109</span><span class="sxs-lookup"><span data-stu-id="d7eea-499">109</span></span></p></li>
<li><p><span data-ttu-id="d7eea-500">109</span><span class="sxs-lookup"><span data-stu-id="d7eea-500">109</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="d7eea-501">LAN</span><span class="sxs-lookup"><span data-stu-id="d7eea-501">LAN</span></span></p></li>
<li><p><span data-ttu-id="d7eea-502">LAN</span><span class="sxs-lookup"><span data-stu-id="d7eea-502">LAN</span></span></p></li>
<li><p></p></li>
<li><p><span data-ttu-id="d7eea-503">LAN</span><span class="sxs-lookup"><span data-stu-id="d7eea-503">LAN</span></span></p></li>
<li><p><span data-ttu-id="d7eea-504">LAN</span><span class="sxs-lookup"><span data-stu-id="d7eea-504">LAN</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<p><span data-ttu-id="d7eea-505">33</span><span class="sxs-lookup"><span data-stu-id="d7eea-505">33</span></span></p>
<p><span data-ttu-id="d7eea-506">83</span><span class="sxs-lookup"><span data-stu-id="d7eea-506">83</span></span></p>
<p></p>
<p><span data-ttu-id="d7eea-507">100</span><span class="sxs-lookup"><span data-stu-id="d7eea-507">100</span></span></p>
<p><span data-ttu-id="d7eea-508">160</span><span class="sxs-lookup"><span data-stu-id="d7eea-508">160</span></span></p></td>
</tr>
<tr class="odd">
<td align="left"><p><span data-ttu-id="d7eea-509">Conexão de rede entre o servidor de streaming do cliente e do App-V 5,0.</span><span class="sxs-lookup"><span data-stu-id="d7eea-509">Network connection between client and App-V 5.0 streaming server.</span></span></p></td>
<td align="left"><p><span data-ttu-id="d7eea-510">rede de link lento de 1,5 Mbps.</span><span class="sxs-lookup"><span data-stu-id="d7eea-510">1.5 Mbps Slow link network.</span></span></p></td>
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="d7eea-511">100</span><span class="sxs-lookup"><span data-stu-id="d7eea-511">100</span></span></p></li>
<li><p></p></li>
<li><p><span data-ttu-id="d7eea-512">100</span><span class="sxs-lookup"><span data-stu-id="d7eea-512">100</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="d7eea-513">3,5 MB</span><span class="sxs-lookup"><span data-stu-id="d7eea-513">3.5 MB</span></span></p></li>
<li><p></p></li>
<li><p><span data-ttu-id="d7eea-514">5 MB</span><span class="sxs-lookup"><span data-stu-id="d7eea-514">5 MB</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="d7eea-515">Rede intra-continental de 1,5 Mbps</span><span class="sxs-lookup"><span data-stu-id="d7eea-515">1.5 Mbps Intra-Continental Network</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<p><span data-ttu-id="d7eea-516">102</span><span class="sxs-lookup"><span data-stu-id="d7eea-516">102</span></span></p>
<p></p>
<p><span data-ttu-id="d7eea-517">121</span><span class="sxs-lookup"><span data-stu-id="d7eea-517">121</span></span></p></td>
</tr>
</tbody>
</table>
...
<span data-ttu-id="d7eea-518">Cada servidor de streaming do App-V 5,0 deve ser capaz de manipular um mínimo de 200 clientes que transmitiram simultaneamente aplicativos virtualizados.</span><span class="sxs-lookup"><span data-stu-id="d7eea-518">Each App-V 5.0 streaming server should be able to handle a minimum of 200 clients concurrently streaming virtualized applications.</span></span>

<span data-ttu-id="d7eea-519">**Observação**  O tempo real para o fluxo será determinado principalmente pelo número de clientes que estão sendo transmitidos simultaneamente, número de pacotes, tamanho do pacote, atividade da rede do servidor e condições da rede.</span><span class="sxs-lookup"><span data-stu-id="d7eea-519">**Note** The actual time to it will take to stream is determined primarily by the number of clients streaming simultaneously, number of packages, package size, the server’s network activity, and network conditions.</span></span>

 

<span data-ttu-id="d7eea-520">Por exemplo, um usuário médio pode transmitir um pacote de 100 MB em menos de 2 minutos, quando 100 clientes simultâneos estão transmitindo do servidor.</span><span class="sxs-lookup"><span data-stu-id="d7eea-520">For example, an average user can stream a 100 MB package in less than 2 minutes, when 100 simultaneous clients are streaming from the server.</span></span> <span data-ttu-id="d7eea-521">No entanto, um pacote de tamanho 1 GB pode levar até 30 minutos.</span><span class="sxs-lookup"><span data-stu-id="d7eea-521">However, a package of size 1 GB could take up to 30 minutes.</span></span> <span data-ttu-id="d7eea-522">Na maioria dos ambientes do mundo real, a demanda de transmissão não é distribuída de maneira uniforme, você precisará compreender os requisitos de streaming de pico aproximados presentes no ambiente para dimensionar corretamente o número de servidores de streaming necessários.</span><span class="sxs-lookup"><span data-stu-id="d7eea-522">In most real world environments streaming demand is not uniformly distributed, you will need to understand the approximate peak streaming requirements present in your environment in order to properly size the number of required streaming servers.</span></span>

<span data-ttu-id="d7eea-523">O número de clientes em que um servidor de streaming pode oferecer suporte pode ser aumentado significativamente e os requisitos de pico de streaming reduzidos se você armazenar previamente em cache seus aplicativos.</span><span class="sxs-lookup"><span data-stu-id="d7eea-523">The number of clients a streaming server can support can be significantly increased and the peak streaming requirements reduced if you pre-cache your applications.</span></span> <span data-ttu-id="d7eea-524">Você também pode aumentar o número de clientes para o qual um servidor de streaming pode oferecer suporte usando pacotes otimizados sob demanda e pacotes otimizados de fluxo.</span><span class="sxs-lookup"><span data-stu-id="d7eea-524">You can also increase the number of clients a streaming server can support by using on-demand streaming delivery and stream optimized packages.</span></span>

## <span data-ttu-id="d7eea-525">Combinando funções de servidor do App-V 5,0</span><span class="sxs-lookup"><span data-stu-id="d7eea-525">Combining App-V 5.0 Server Roles</span></span>


<span data-ttu-id="d7eea-526">Com a descontamento dos requisitos de dimensionamento e tolerância a falhas, o número mínimo de servidores necessários para um local com conectividade com o Active Directory é um.</span><span class="sxs-lookup"><span data-stu-id="d7eea-526">Discounting scaling and fault-tolerance requirements, the minimum number of servers needed for a location with connectivity to Active Directory is one.</span></span> <span data-ttu-id="d7eea-527">Este servidor hospedará as funções servidor de gerenciamento, serviço servidor de gerenciamento e Microsoft SQL Server.</span><span class="sxs-lookup"><span data-stu-id="d7eea-527">This server will host the management server, management server service, and Microsoft SQL Server roles.</span></span> <span data-ttu-id="d7eea-528">As funções de servidor, portanto, podem ser organizadas em qualquer combinação desejada porque elas não entram em conflito umas com as outras.</span><span class="sxs-lookup"><span data-stu-id="d7eea-528">Server roles, therefore, can be arranged in any desired combination since they do not conflict with one another.</span></span>

<span data-ttu-id="d7eea-529">Ignorar requisitos de dimensionamento, o número mínimo de servidores necessários para fornecer uma implementação tolerante a falhas é de quatro.</span><span class="sxs-lookup"><span data-stu-id="d7eea-529">Ignoring scaling requirements, the minimum number of servers necessary to provide a fault-tolerant implementation is four.</span></span> <span data-ttu-id="d7eea-530">O servidor de gerenciamento e as funções do Microsoft SQL Server dão suporte a serem colocadas em configurações tolerantes a falhas.</span><span class="sxs-lookup"><span data-stu-id="d7eea-530">The management server, and Microsoft SQL Server roles support being placed in fault-tolerant configurations.</span></span> <span data-ttu-id="d7eea-531">O serviço do servidor de gerenciamento pode ser combinado com qualquer uma das funções, mas permanece um ponto único de falha.</span><span class="sxs-lookup"><span data-stu-id="d7eea-531">The management server service can be combined with any of the roles, but remains a single point of failure.</span></span>

<span data-ttu-id="d7eea-532">Embora existam várias estratégias e tecnologias de tolerância a falhas disponíveis, nem todas são aplicáveis a um serviço específico.</span><span class="sxs-lookup"><span data-stu-id="d7eea-532">Although there are a number of fault-tolerance strategies and technologies available, not all are applicable to a given service.</span></span> <span data-ttu-id="d7eea-533">Além disso, se as funções do App-V 5,0 forem combinadas, algumas opções de tolerância a falhas não poderão mais se aplicar devido a incompatibilidades.</span><span class="sxs-lookup"><span data-stu-id="d7eea-533">Additionally, if App-V 5.0 roles are combined, certain fault-tolerance options may no longer apply due to incompatibilities.</span></span>
...
## <span data-ttu-id="d7eea-534">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="d7eea-534">Related topics</span></span>


[<span data-ttu-id="d7eea-535">Configurações com suporte ao App-V 5.0</span><span class="sxs-lookup"><span data-stu-id="d7eea-535">App-V 5.0 Supported Configurations</span></span>](app-v-50-supported-configurations.md)

[<span data-ttu-id="d7eea-536">Planejamento de alta disponibilidade com o App-V 5.0</span><span class="sxs-lookup"><span data-stu-id="d7eea-536">Planning for High Availability with App-V 5.0</span></span>](planning-for-high-availability-with-app-v-50.md)

[<span data-ttu-id="d7eea-537">Planejando a implantação do App-V</span><span class="sxs-lookup"><span data-stu-id="d7eea-537">Planning to Deploy App-V</span></span>](planning-to-deploy-app-v.md)
